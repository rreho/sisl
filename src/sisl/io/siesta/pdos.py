...
# @set_module("sisl.io.siesta")
# class apdosSileSiesta(pdosSileSiesta):
#     @sile_fh_open(True)
#     def read_data(self, as_dataarray: bool = False):
#         r"""Returns data associated with the PDOS file
...
#                 spin = ["sum", "x", "y", "z"]
#             elif nspin == 8 :
#                 spin = ["heT_S", "heT_z", "heT_x", "heT_y", "ehT_S", "ehT_z", "ehT_x", "ehT_y"]                  
...
# add_sile("ANPDOS",apdosSileSiesta, gzip = True )
#  pdos.xml/siesta.PDOS.xml
add_sile("PDOS.xml", pdosSileSiesta, gzip=True)
# add_sile("ANPDOS.xml", apdosSileSiesta, gzip=True)
